...
namespace ProjetoDimDim.Controllers
{
    public class ProjetosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProjetoId,Nome,Descricao,Dificuldade")] Projeto projeto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProjetoId,Nome,Descricao,Dificuldade")] Projeto projeto)
        {
